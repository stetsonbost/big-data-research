...
\begin{figure}
  \centering
        \subfloat[][Start with a list of tasks that need to be completed. Each task has a deadline, estimated duration, and intensity level, where a higher intensity level corresponds to a more difficult or stressful task.]{\includegraphics[scale=0.152]{TaskList.pdf}%
